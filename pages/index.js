...
export default function Home({ blogs, profile }) {
  // const profile={
  //   websiteTitle:"Sourik",
  //   profileTitle:"I'm Sourik Parui, B-TECH Student & || a Web Designer || Coder",
  //   profileDetailes:` Hi, My name is Sourik Parui currently I'm persuing BTech in ECE from BCET: Top B.tech Engineering College in Durgapur .
  //   Taking about my qualities, I am a very optimistic person as I see possibilities instead of limitations at my work also I am a true leader.
  //   I love to work as a team and have a excellent communication skills.
  //   comming towards my achievements, I have done some project ,there are E-COMMERCE website, VOICE-ASSISTANT-AI-PYTHON, NOTEBOOK website,NEWSWORLD website and a Chatting website.
  //   My technical skills are C, JAVA and Python as a programming language and  I also know HTML,CSS,JAVASCRIPT,NODE.JS,EXPRESS.JS,REACT,
  //   TAILWIND CSS,BOOTSTRAP,STRAPI.JS,SANITY.IO and entity framework which helps me in web development.
  //   My hobbies is listening to music,Playing Cricket and traveling.`,
  //   name:"Sourik Parui",
  //   age:19,
  //   image:"",
  //   fbLink:"",
  ...
  //   instaLink:"",
  //   githubLink:"",
  //   contactNo:"9875320238 / 7872422062",
  //   email:"sourikparui100403@gmail.com",
  //   address:"Home:Parabagnan,arambagh,hooghly / current address:Durgapur,West Bengal",
  //   copyright:"© Copyright 2022. All right reserved,@sourikparui100403.",
  //   clang:80,
  //   javalang:70,
  //   python:75,
  //   html_css:80,
  ...
  return (
    <><>
      ...
      <Head>
        ...
        <title>{profile.websiteTitle}- PORTFOLIO | BLOG </title>
          ...
          <div className="w-full pl-0 pt-10 sm:w-3/4 lg:w-2/5 lg:pl-12 lg:pt-0">
            <div>
              <div className="flex items-end justify-between">
                ...
                <h3 className="font-body text-3xl font-bold text-primary">{profile.clang}%</h3>
              </div>
              <div className="mt-2 h-3 w-full rounded-full bg-lila">
                <div className="h-3 rounded-full bg-primary" style={{ "width": `${profile.clang}%` }}></div>
              </div>
            </div>
            <div className="pt-6">
              <div className="flex items-end justify-between">
                <h4 className="font-body font-semibold uppercase text-black">Java</h4>
                <h3 className="font-body text-3xl font-bold text-primary">{profile.javalang}%</h3>
              </div>
              <div className="mt-2 h-3 w-full rounded-full bg-lila">
                <div className="h-3 rounded-full bg-primary" style={{ "width": `${profile.javalang}%` }}></div>
              </div>
            </div>
            <div className="pt-6">
              <div className="flex items-end justify-between">
              ...
              <div className="mt-2 h-3 w-full rounded-full bg-lila">
                <div className="h-3 rounded-full bg-primary" style={{ "width": `${profile.python}%` }}></div>
              </div>
            </div>
            <div className="pt-6">
              <div className="flex items-end justify-between">
                <h4 className="font-body font-semibold uppercase text-black">HTML & CSS</h4>
                <h3 className="font-body text-3xl font-bold text-primary">{profile.html_css}%</h3>
              </div>
              <div className="mt-2 h-3 w-full rounded-full bg-lila">
                <div className="h-3 rounded-full bg-primary" style={{ "width": `${profile.html_css}%` }}></div>
              </div>
            </div>
            <div className="pt-6">
              <div className="flex items-end justify-between">
              ...
              <div className="mt-2 h-3 w-full rounded-full bg-lila">
                <div className="h-3 rounded-full bg-primary" style={{ "width": `${profile.javascript}%` }}></div>
              </div>
            </div>
            <div className="pt-6">
              <div className="flex items-end justify-between">
                <h4 className="font-body font-semibold uppercase text-black">Node.js</h4>
                <h3 className="font-body text-3xl font-bold text-primary">{profile.nodejs}%</h3>
              </div>
              <div className="mt-2 h-3 w-full rounded-full bg-lila">
                <div className="h-3 rounded-full bg-primary" style={{ "width": `${profile.nodejs}%` }}></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 gap-6 pt-10 sm:grid-cols-2 md:gap-10 md:pt-12 lg:grid-cols-3">
          ...
          <div className="group rounded px-8 py-12 shadow hover:bg-primary">
            ...
            <div className="text-center">
              ...
              <p className="text-grey pt-4 text-sm group-hover:text-white md:text-base">
                Image result for web designing course about
      ...
      <div className="container py-16 md:py-20" id="contact">
        ...
        <div className="mx-auto w-full pt-5 text-center sm:w-2/3 lg:pt-6">
          <p className="font-body text-grey-10">
            If you have any quries about anu thing. please contact us
          </p>
        </div>
